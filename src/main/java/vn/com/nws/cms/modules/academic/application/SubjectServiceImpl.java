...
public class SubjectServiceImpl implements SubjectService {
    ...
    public PageResponse<SubjectResponse> getSubjects(SubjectFilterRequest request) {
        ...
        List<SubjectResponse> responses = subjects.stream().map(this::toResponse).collect(Collectors.toList());
    ...
    public SubjectResponse getSubjectById(Long id) {
        Subject subject = subjectRepository.findById(id).orElseThrow(() -> new BusinessException("Subject not found"));
